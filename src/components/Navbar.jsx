      ...
      <div className="container px-4 mx-auto relative lg:text-sm">
        <div className="flex justify-between items-center">
          ...
          <ul className="hidden lg:flex ml-14 space-x-12 ">
            <li className="relative transition-all duration-300 hover:text-[#e88924] group"> <Link
              to="FeatureSection"
              spy={true}
              smooth={true}
              offset={50}
              duration={500}> <a href="/service" className="after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-[#e88924] after:left-0 after:-bottom-1 after:transition-all after:duration-300 group-hover:after:w-full">Service </a> </Link> </li>
            ...
            <li className="relative transition-all duration-300 hover:text-[#e88924] group"> <Link
              ...
              smooth={true}
              offset={50}
              duration={500}> <a href="/service" className="after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-[#e88924] after:left-0 after:-bottom-1 after:transition-all after:duration-300 group-hover:after:w-full">About </a> </Link> </li>

            <li className="relative transition-all duration-300 hover:text-[#e88924] group"> <Link activeClass="active"
              to="Testimonials"
              spy={true}
              smooth={true}
              offset={50}
              duration={500}> <a href="/service" className="after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-[#e88924] after:left-0 after:-bottom-1 after:transition-all after:duration-300 group-hover:after:w-full">Testimonials</a> </Link> </li>
            {/* 
            <li> <Link
              to="OurWorkSection"
              spy={true}
              smooth={true}
              offset={50}
              duration={500}> <a href="/service">Our Works</a> </Link> </li> */}
            ...
            <li className="relative transition-all duration-300 hover:text-[#e88924] group"> <Link
              ...
              smooth={true}
              offset={50}
              duration={500}> <a href="/service" className="after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-[#e88924] after:left-0 after:-bottom-1 after:transition-all after:duration-300 group-hover:after:w-full">Contacts</a> </Link> </li>
          ...
          <div className="hidden lg:flex justify-center space-x-1 items-center">
            <a href="https://www.instagram.com/rivermarketingmedia/" target="_blank" rel="noopener noreferrer">
              <button className="btn btn-ghost btn-circle  duration-300 ease-in-out hover:scale-110 hover:bg-white hover:rounded-full p-2 m-4 ">
        ...
        {mobileDrawerOpen && (
          <div ref={drawerRef} className="fixed right-0 z-20 bg-neutral-900 w-full p-12 flex flex-col justify-center items-center lg:hidden">
            <ul className="space-y-6">
              <li className="relative transition-all duration-300 hover:text-[#e88924] group"> <Link
                ...
                smooth={true}
                offset={50}
                duration={500}> <a href="/service" className="text-lg after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-[#e88924] after:left-0 after:-bottom-1 after:transition-all after:duration-300 group-hover:after:w-full">Service </a> </Link> </li>
              ...
              <li className="relative transition-all duration-300 hover:text-[#e88924] group"> <Link
                ...
                smooth={true}
                offset={50}
                duration={500}> <a href="/service" className="text-lg after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-[#e88924] after:left-0 after:-bottom-1 after:transition-all after:duration-300 group-hover:after:w-full">About </a> </Link> </li>
              ...
              <li className="relative transition-all duration-300 hover:text-[#e88924] group"> <Link activeClass="active"
                ...
                smooth={true}
                offset={50}
                duration={500}> <a href="/service" className="text-lg after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-[#e88924] after:left-0 after:-bottom-1 after:transition-all after:duration-300 group-hover:after:w-full">Testimonials</a> </Link> </li>
              ...
              <li className="relative transition-all duration-300 hover:text-[#e88924] group"> <Link
                ...
                smooth={true}
                offset={50}
                duration={500}> <a href="/service" className="text-lg after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-[#e88924] after:left-0 after:-bottom-1 after:transition-all after:duration-300 group-hover:after:w-full">Contacts</a> </Link> </li>
            </ul>
